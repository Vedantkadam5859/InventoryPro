...
class Login_System:
    def __init__(self,root):
        self.root=root
        self.root.title("InventryPro | Developed By Vedant Kadam")
        ...
        title=Label(login_frame,text="InventoryPro",font=("Elephant",15,"bold"),bg="white").place(x=0,y=30,relwidth=1)
        lbl_user=Label(login_frame,text="Customer ID",font=("Andalus",15),bg="white",fg="#767171").place(x=50,y=100)
        ...
        btn_forget=Button(login_frame,text="Forgot Password",font=("Arial Rounded MT Bold",10),bg="white",activebackground="#00759E",fg="#00759E",activeforeground="white",cursor="hand2").place(x=50,y=400)

        register_frame=Frame(self.root,bd=2,relief=RIDGE,bg="white")
        register_frame.place(x=650,y=570,width=350,height=60)
        lbl_reg=Label(register_frame,text="DEVELOPED BY VEDANT KADAM ",font=("times new roman",13),bg="white").place(x=0,y=19,relwidth=1)
