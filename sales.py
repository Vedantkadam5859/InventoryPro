...
class salesClass:
    def __init__(self,root):
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("times new roman ",15,"bold"),bg="lightgrey",fg="black",cursor="hand2").place(x=490,y=100,width=120,height=28)
        ...
        lbl_title=Label(bill_Frame,text="Customer Bill Area",bg="orange").pack(side=TOP,fill=X)
       
        scrolly2=Scrollbar(bill_Frame,orient=VERTICAL)
        self.bill_area=Text(bill_Frame,font=("goudy old style",13),bg="white",yscrollcommand=scrolly2.set)
