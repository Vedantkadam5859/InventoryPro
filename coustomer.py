    ...
    def add(self):  
        ...
        try:
            if self.var_coust_id.get()=="":  
                messagebox.showerror("Error","Customer ID Must be Required",parrent=self.root)
            else:
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Sucess","Customer added Sucessfully",parent=self.root)
                    self.show()
        ...
        try:
            if self.var_coust_id.get()=="":  
                ...
                if row==None:
                    ...
                    con.commit()
                    messagebox.showinfo("Sucess","Customer updated Sucessfully",parent=self.root)
                    self.show()
        except Exception as ex:
            messagebox.showerror("Error",f"Error due to : {(ex)}",parent=self.root)   
            ...
            if self.var_coust_id.get()=="":  
                ...
                if row==None:
                   ...
                   if op==True:     
                        ...
                        con.commit()
                        messagebox.showinfo("delete","Customer deleted Sucessfully",parent=self.root)
                        self.show()
